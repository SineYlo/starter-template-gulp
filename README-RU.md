...
|    ├── tasks                                              # в эту папке хранятся таски
...
|    |    ├── _transfer-docs.js                             # таск - перемешение документов
...
|    |    ├── _transfer-video.js                            # таск - перемешение видео
...
|    |    └── video                                         # в эту папку складываем видо-файлы
...
|    |    ├── home                                          # в эту папку складываем растровую графика для главной страницы
|    |    └── pages                                         # в эту папку складываем растровую графика для дополнительных страниц
...
|    |    |    |    └── _header.scss                        # готовый файл для гапки сайта
...
|    |    ├── config                                        # в этой папке хравнятся разные настройки (подключение шрифтов и переменные)
...
|    |    |    |         ├── _block-position.scss           # в этом файле хранятся миксины связанные с позиционированнием
|    |    |    |         ├── _breakpoints.scss              # в этом файле хранятся миксины с брейкпоинтамми
...
|    |    |         ├── home                                # в эту папку склажываем похожие файлы, но для главной страницы
|    |    |         └── pages                               # в эту папку склажываем похожие файлы, но для дополнительных страниц
...
|    |    |    ├── home                                     # в этой папке находится файл в который мы подключаем библиотеке для главной страницы
...
├── .ecrc                                                   # в этом файле прописаны файлы и папки, которые не будут проверятся с помощью editorconfig-checker
├── .editorconfig                                           # файл с настройкамм табуляции
